...
namespace Onbox.TypeSharp
{
    ...
    {
        [Option('s', "source", Required = true, HelpText = "The full path name of the folder to be converted and/or to be watched. Sub diretories will also be considered. This path is not case sensitive.")]
